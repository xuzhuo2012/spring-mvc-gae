	...
	<div id="slider">
		...
		<div id="templatemo_main">
			<ul id="social_box">
				...
				<li>
					<a href="#">
						<img src="resources/images/linkedin.png" alt="linkin" />
					</a>
				</li>
				<li>
					<a href="#">
						<img src="resources/images/technorati.png" alt="technorati" />
					</a>
				</li>
				<li>
					<a href="#">
						<img src="resources/images/myspace.png" alt="myspace" />
					</a>
				</li>
			</ul>
